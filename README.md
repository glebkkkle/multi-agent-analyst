...
\<div align="center"\>  
\<img src="./docs/dashboard\_main.png" alt="Main Dashboard" width="100%" /\>  
\<div style="display: flex; justify-content: center; gap: 10px; margin-top: 10px;"\>  
\<img src="./docs/agent\_trace.png" alt="Agent Execution Trace" width="48%" /\>  
\<img src="./docs/visualization\_example.png" alt="Generated Visualization" width="48%" /\>  
\</div\>  
\</div\>
