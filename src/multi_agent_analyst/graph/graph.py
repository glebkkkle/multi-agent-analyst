...
graph.add_conditional_edges('context_node', routing, {'chat':'chat_reply', 'planner': 'planner', 'ask_user':'ask_user', 'clarification_provided':'clarification_node'})
...
graph.add_edge('clarification_node', 'chat_node')
...
#planning should request a strict operation whether analytical or visual 
#chat node should be used for other purposes
